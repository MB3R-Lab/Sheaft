...
4. `internal/simulation` runs deterministic Monte Carlo analysis for one or more profiles, preserving `1.0.0` baseline semantics while enabling `1.3.0` path-aware diagnostics.
